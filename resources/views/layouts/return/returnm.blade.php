...
<head>
  ...
  <title>Library System Singapore Amicus International School</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="brand-link">
        <img src="{{ asset('images/logoASA1.jpg') }}"  class="brand-image img-circle elevation-3" style="margin-right:21px;opacity: .8, with: 22px, ">
        <span>
            <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open ">
            <a href="{{ route('return.index') }}" class="nav-link active">
                <i class="fa-solid fa-retweet"></i>
              <p>
                Story Return
...
<script>
  $(function () {
    ...
    $("#example1").DataTable({
      "responsive": true, "lengthChange": false,  "pageLength": 20, "autoWidth": false,
    ...
    $('#example1_wrapper .col-md-6:eq(1)').remove();
  });
</script>
</body>
</html>
